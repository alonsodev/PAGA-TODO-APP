...
export class PreloadState extends State {
  ...
  preload() {
    ...
    this.load.spritesheet('pillx', 'assets/sprites/power-pill.png', 16, 16);

    this.load.spritesheet('pillx1', 'assets/sprites/16x16/app-pacman-01.png', 16, 16);
    this.load.spritesheet('pillx2', 'assets/sprites/16x16/app-pacman-02.png', 16, 16);
    this.load.spritesheet('pillx3', 'assets/sprites/16x16/app-pacman-03.png', 16, 16);
    this.load.spritesheet('pillx4', 'assets/sprites/16x16/app-pacman-04.png', 16, 16);
